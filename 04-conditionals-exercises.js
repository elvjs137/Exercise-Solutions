...
*/ if (num > 12) console.log("num is greater than 10");

process.stdout.write("\n*4·11. ");
/*
 *4·11. Only print the message 'num is less than 100' when appropriate.
 */
if (num < 100) console.log("num is less than 100");
 ...
 */
if (num > 10 && num < 100) console.log("num is between 10 and 100");
 ...
 */
if (num % 2 !== 0 || num < 0) console.log("num is odd or negative");
 ...
 */
if (username === "Zed" && password === "9876") {
  console.log("Login successful");
} else if (username !== "Zed") {
...
if (myUsername === employeeUsername && myPassword === employeePassword) {
  ...
  if (salary >= ceoSalaryMinimum) {
    console.log("Welcome, CEO " + myUsername + ".");
  } else {
